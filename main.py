...
if __name__ == "__main__":
 ...
 # я создал метод `_handle_events`, который обрабатывает события игры, включая движение игрока.
 # создал метод `_update_game` отвечает за обновление экрана, включая отображение игровых элементов и проверку завершения игры.
 # разбил весь код на более маленькие функции для удобства работы, но реализовал их другими методами
